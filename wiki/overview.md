...
AI/ML Engineer. Building from first principles. Final year undergrad, LNCT Bhopal.
...
Implements architectures from scratch as the primary learning strategy — not fine-tuning wrappers, but writing the math as code. Believes in shipping production systems, not just notebooks.
...
### AI Intern
- Architected intelligent research profiling system
- Aggregated data from PubMed, ResearchGate, Google Scholar APIs
- Built RAG-powered search agents for contextual recommendations and collaborator discovery
- Collaborated with healthcare professionals on search algorithm refinement
- Stack: LangChain, FastAPI, modern AI frameworks
...
| Domain | Depth |
|--------|-------|
| Computer Vision | Deep — YOLOv5-v8, OpenCV, tracking, segmentation, medical imaging |
| GenAI & Agents | Deep — LangGraph, AG2, CrewAI, smolagents, MCP, RAG |
| Deep Learning | Deep — PyTorch, TensorFlow, from-scratch implementations |
| MLOps | Deep — DVC, MLflow, ZenML, Docker, AWS, CI/CD, monitoring |
| Research | Strong — 11 CV architectures implemented, 5 LLM architectures |
| Development | Solid — FastAPI, Next.js, Streamlit, Flask |
