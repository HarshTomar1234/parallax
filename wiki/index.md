...
sources: [github-profile, portfolio, resumes, recommendation-letter]
...
|------|--------|---------|-------------|
| [[insureml-pipeline]] | Auto | Newly ingested repository | Actions, LLM |
...
| [[decifra]] | MLOps / XAI | Advanced Explainable AI visualization dashboards | React, SHAP, LIME |
| [[molecuquest]] | Drug Discovery AI | Molecule property prediction pipeline | GNNs, Deep Learning |
...
|------|-------------|---------|---------|-------------|
| [[transformers-cv]] | 11-arch library | Complete implementation of 11 core CV architectures | 173 | PyTorch, Deep Learning |
| [[vlmverse]] | PaLiGemma VLM | Vision-Language Model fine-tuning & inference | ~45 | HuggingFace, PEFT |
...
| Page | Topic |
|------|-------|
| [[attention-mechanisms]] | Transformers, MHSA, RoPE |
| [[diffusion-models]] | DDPM, score matching |
| [[rag-architectures]] | Vector DBs, retrieval |
...
## Links
- GitHub: https://github.com/HarshTomar1234
- Portfolio: https://kernel-crush.netlify.app
- LinkedIn: https://www.linkedin.com/in/harsh-tomar-a96a38256/
- X: https://x.com/kernel_crush
