<p align="center">
  ...
  <p align="center">
    <strong>A self-organizing, AI-maintained knowledge base for Machine Learning, Computer Vision, and Generative AI.</strong>
  </p>
  <p align="center">
  ...
  <p align="center">
    ...
    <a href="AGENTS.md"><img src="https://img.shields.io/badge/agent--maintained-✓-purple?style=flat-square" alt="Agent Maintained"></a>
  </p>
</p>
...
Parallax is **not a portfolio**. It is a persistent, compounding knowledge system — a living architectural map maintained by specialized LLM agents. Every page is interlinked, every concept cross-referenced, and the entire graph is designed to be navigated by both humans and AI.
...
The repository utilizes autonomous agents defined in [`AGENTS.md`](AGENTS.md). These agents perform:
...
- **Agents:** LLM-powered workflows via AGENTS.md schema
- **Hosting:** Static files — deployable to GitHub Pages, Netlify, or any CDN
...
<p align="center">
  ...
  <br>
  <a href="https://kernel-crush.netlify.app">Portfolio</a> · <a href="https://www.linkedin.com/in/harsh-tomar-a96a38256/">LinkedIn</a> · <a href="https://x.com/kernel_crush">X</a>
</p>
